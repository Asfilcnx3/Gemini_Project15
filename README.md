# Gemini_Project15 – Analizador de Datos con Lenguaje Natural // Data Analyzer from natural language

## Funcionalidades
- Analiza tus propios datos estructurados sin escribir código.
- Responde en español o inglés, según la consulta.
...
- LangChain: para conectar el modelo con el dataframe.
- Gradio: para construir la interfaz interactiva.
- Hugging Face Spaces: para alojar la demo web.
